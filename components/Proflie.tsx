      ...
      <div className="flex flex-col min-[1100px]:flex-row items-center justify-center m-auto gap-10 lg:gap-20 py-10">
         ...
         >
            ...
            <p className="text-opacity-60 text-sm max-w-3xl ">
               ...
               excellent front-end and mobile app development and designing
               skills, as well as a flexible working environment,
               Responsibility, and willingness to learn new things.
            </p>
            <button className="p-3 bg-slate-700 rounded-md mt-2">
               <a href="https://drive.google.com/file/d/1MyBDlZEkmgcRPAM_6bLLQyx6xUULG3ia/view?usp=sharing">
                  Preview CV
               </a>
            </button>
         </motion.div>
